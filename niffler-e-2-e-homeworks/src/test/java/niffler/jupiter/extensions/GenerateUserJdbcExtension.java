...
public class GenerateUserJdbcExtension implements ParameterResolver, BeforeEachCallback, AfterTestExecutionCallback {

    public static ExtensionContext.Namespace NAMESPACE = ExtensionContext.Namespace
            .create(GenerateUserJdbcExtension.class);
    ...
    public void beforeEach(ExtensionContext context) throws Exception {
        ...
        GenerateUserWithJdbc annotation = context.getRequiredTestMethod().getAnnotation(GenerateUserWithJdbc.class);
        if (annotation != null) {
    ...
    public boolean supportsParameter(ParameterContext parameterContext,
        ...
        return parameterContext.getParameter().getType().isAssignableFrom(UserEntity.class)
                && extensionContext.getRequiredTestMethod().getAnnotation(GenerateUserWithJdbc.class) != null;
    }

    @Override
    public Object resolveParameter(ParameterContext parameterContext,
                                   ExtensionContext extensionContext) throws ParameterResolutionException {
        GenerateUserWithJdbc annotation = extensionContext.getRequiredTestMethod().getAnnotation(GenerateUserWithJdbc.class);
        if (annotation != null) {
